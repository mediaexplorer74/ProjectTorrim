...
namespace BrawlerSource.Collision.Intersections
{
  public static class Intersection
  {
    ...
    {
      return (double) point.Position.X > (double) rectangle.Left && (double) point.Position.X < (double) rectangle.Right && (double) point.Position.Y > (double) rectangle.Top && (double) point.Position.Y < (double) rectangle.Bottom;
    }

    public static bool CircleInCircle(Circular circle1, Circular circle2)
    {
      return circle1.Position.DistanceToSquared(circle2.Position) < Math.Pow((double) circle1.Radius + (double) circle2.Radius, 2.0);
    }

    public static bool RectangleInRectangle(Rectangular rectangle1, Rectangular rectangle2)
    {
      return (double) rectangle1.Right > (double) rectangle2.Left && (double) rectangle1.Left < (double) rectangle2.Right && (double) rectangle1.Bottom > (double) rectangle2.Top && (double) rectangle1.Top < (double) rectangle2.Bottom;
    }
