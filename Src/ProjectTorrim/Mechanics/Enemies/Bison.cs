...
// Type: BrawlerSource.Mechanics.Enemies.Bison
...
namespace BrawlerSource.Mechanics.Enemies
{
  ...
  {
    public Bison(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 675, 80, path)
    {
    }

    public Bison(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 675, 80, path)
    {
    }
