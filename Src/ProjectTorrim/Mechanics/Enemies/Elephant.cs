...
// Type: BrawlerSource.Mechanics.Enemies.Elephant
...
namespace BrawlerSource.Mechanics.Enemies
{
  ...
  {
    public Elephant(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 18225, 60, path)
    {
    }

    public Elephant(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 18225, 60, path)
    {
    }
