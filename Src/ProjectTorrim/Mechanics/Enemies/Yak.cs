...
// Type: BrawlerSource.Mechanics.Enemies.Yak
...
{
  public class Yak : Enemy
  {
    public Yak(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 20, 100, path)
    {
    }

    public Yak(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 20, 100, path)
    {
    }
