...
// Type: BrawlerSource.Mechanics.Enemies.Rhino
...
namespace BrawlerSource.Mechanics.Enemies
{
  ...
  {
    public Rhino(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 2025, 60, path)
    {
    }

    public Rhino(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 2025, 60, path)
    {
    }
