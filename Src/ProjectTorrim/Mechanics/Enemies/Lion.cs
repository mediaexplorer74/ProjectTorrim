...
// Type: BrawlerSource.Mechanics.Enemies.Lion
...
namespace BrawlerSource.Mechanics.Enemies
{
  ...
  {
    public Lion(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 6075, 70, path)
    {
    }

    public Lion(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 6075, 70, path)
    {
    }
