...
// Type: BrawlerSource.Mechanics.Bosses.Minotaur
...
namespace BrawlerSource.Mechanics.Bosses
{
  ...
  {
    public Minotaur(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 10125, 40, path)
    {
    }

    public Minotaur(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 10125, 40, path)
    {
    }
