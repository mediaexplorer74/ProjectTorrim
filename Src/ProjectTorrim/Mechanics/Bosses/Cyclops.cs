...
// Type: BrawlerSource.Mechanics.Bosses.Cyclops
...
{
  public class Cyclops : Boss
  {
    public Cyclops(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 273375, 40, path)
    {
    }

    public Cyclops(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 273375, 40, path)
    {
    }
