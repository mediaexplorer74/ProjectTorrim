...
// Type: BrawlerSource.Mechanics.Bosses.Hydra
...
namespace BrawlerSource.Mechanics.Bosses
{
  ...
  {
    public Hydra(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 3375, 40, path)
    {
    }

    public Hydra(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 3375, 40, path)
    {
    }
