...
// Type: BrawlerSource.Mechanics.Bosses.Griffin
...
{
  public class Griffin : Boss
  {
    public Griffin(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 91125, 40, path)
    {
    }

    public Griffin(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 91125, 40, path)
    {
    }
