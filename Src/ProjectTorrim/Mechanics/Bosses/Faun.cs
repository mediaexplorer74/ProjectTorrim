...
// Type: BrawlerSource.Mechanics.Bosses.Faun
...
{
  public class Faun : Boss
  {
    public Faun(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 1125, 40, path)
    {
    }

    public Faun(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 1125, 40, path)
    {
    }
