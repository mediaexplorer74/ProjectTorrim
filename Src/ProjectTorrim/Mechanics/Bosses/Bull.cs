...
// Type: BrawlerSource.Mechanics.Bosses.Bull
...
namespace BrawlerSource.Mechanics.Bosses
{
  ...
  {
    public Bull(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 375, 40, path)
    {
    }

    public Bull(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 375, 40, path)
    {
    }
