...
// Type: BrawlerSource.Mechanics.Bosses.Aeternae
...
{
  public class Aeternae : Boss
  {
    public Aeternae(Layer layer, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(layer, position, 30375, 40, path)
    {
    }

    public Aeternae(GameObject parent, Position position, Queue<BrawlerSource.PathFinding.Node> path)
      : base(parent, position, 30375, 40, path)
    {
    }
