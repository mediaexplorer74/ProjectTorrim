  ...
  public class GameLayer : Layer
  {
    ...
    public void PauseGame(object sender, BrawlerEventArgs e) => this.Level.State = GameStates.Pause;
        ...
        public void SaveGame()
        {
            ...
            File.WriteAllText(System.IO.Path.Combine(/*Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)*/"", 
                "gamesave_" + this.myProfile + ".json"), contents);
        }
