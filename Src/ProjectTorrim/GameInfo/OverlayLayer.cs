...
namespace BrawlerSource.GameInfo
{
  public class OverlayLayer : Layer
  {
    ...
    public override void Initilize()
    {
      ...
      Button button2 = new Button((Layer) this, Align.Centre, new Position(-64f, 154f), new Position(128f, 40f), new MouseFunction(this.Exit));
      button2.SetText("Quit");
      button2.SetTextScale(new Vector2(1f));
      button2.AddToDraw();
      Button button3 = new Button((Layer) this, Align.Centre, new Position(64f, 154f), new Position(128f, 40f), new MouseFunction(this.Back));
